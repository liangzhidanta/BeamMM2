...
# 模型1相关参数设置（加载预训练编码器1）
###############################
CHECKPOINT_DIR1="./checkpoints_scaling_model1"
PRETRAINED_ENCODER_PATH1="/groups/g900403/home/share/wzj/BeamMM/checkpoints/mmwave_gps_joint_s4.pth"  # MMWAVE ANCHOR

###############################
# 模型2相关参数设置（加载预训练编码器2）
###############################
CHECKPOINT_DIR2="./checkpoints_scaling_model2"
PRETRAINED_ENCODER_PATH2="/groups/g900403/home/share/wzj/BeamMM/checkpoints/mmwave_gps_joint_s6.pth"   # VISION ANCHOR

###############################
# 模型3相关参数设置（加载预训练编码器3）
###############################
CHECKPOINT_DIR3="./checkpoints_scaling_model3"
PRETRAINED_ENCODER_PATH3="/groups/g900403/home/share/wzj/BeamMM/checkpoints/mmwave_gps_joint_s8.pth"
...
if [ -f "$BEST_MODEL_PATH1" ]; then
    ...
    python evaluate_MultiModalEncoderDecoderModel.py --model_path "$BEST_MODEL_PATH1"
else
...
###############################
echo "============================="
# echo "开始训练模型3（使用预训练编码器：$PRETRAINED_ENCODER_PATH3）..."
# LOG_FILE3="${CHECKPOINT_DIR3}/training_log_${TIMESTAMP}.txt"
...
#     --learning_rate "$LEARNING_RATE" \
#     --patience "$PATIENCE" \
#     --checkpoint_dir "$CHECKPOINT_DIR3" \
#     --pretrained_encoder_path "$PRETRAINED_ENCODER_PATH3" | tee "$LOG_FILE3"

# echo "模型3训练完成，日志保存在 ${LOG_FILE3}"

# # 模型3训练结束后，评估最佳模型
# BEST_MODEL_PATH3="${CHECKPOINT_DIR3}/multimodal_encoder_decoder_best.pth"
# if [ -f "$BEST_MODEL_PATH3" ]; then
#     echo "开始评估模型3：$BEST_MODEL_PATH3"
#     python evaluate_MultiModalEncoderDecoderModel.py --model_path "$BEST_MODEL_PATH3"
# else
#     echo "未找到模型3的最佳权重文件：$BEST_MODEL_PATH3"
# fi
